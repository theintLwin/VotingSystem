<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Winner.aspx.cs" Inherits="VotingSystem.Winner" %>
...
<body>
    ...
    <div class="wrap" id="">
      ...
      <div class="marquee">
        ...
        <div class="reg">
                <asp:Label ID="CoupleName" runat="server" Text="Label" Font-Bold="True" Font-Size="XX-Large"></asp:Label><br />
                 <asp:Image ID="CoupleImage" runat="server"  Width="300px" Height="400px"/>
            </div>
    </div>
