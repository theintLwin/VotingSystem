<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PopularPage.aspx.cs" Inherits="VotingSystem.PopularPage" %>
...
<head runat="server">
    ...
    <style>
        ...
        body{
        background-image: url(images/queenbg2.jpg);
 ...
 <a href="Popular.aspx">Popular</a>
  ...
  <a href="LoginRegister.aspx" style="margin-left:400px;">Logout</a>
        ...
        <div>
            ...
            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT [Name] FROM [Queen]"></asp:SqlDataSource> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <asp:Button ID="PopularPageVote" runat="server" Text="Vote" Font-Bold="True" Font-Size="XX-Large" ForeColor="#000099" OnClick="PopularPageVote_Click" />
                <br /><br /><br />
                &nbsp;
